...
if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
    ...
    Class Uou_Bookings{
        ...
        public function ub_load_scripts() {
            ...
            if(isset($product_type) && ($product_type === 'uou_booking')){
        ...
        public function ub_admin_load_scripts() {
            wp_register_style( 'bootstrap-admin', UOU_BOOKINGS_URL . '/assets/css/bootstrap-admin.css', array(), false, 'all' );
