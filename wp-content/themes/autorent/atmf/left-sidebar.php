...
<input type="text" placeholder="Tìm nhanh" class="form-control" data-ng-model="QuickSearch">




<h4 class="title-widget"><?php _e('Ngày','autorent'); ?></h4>

<form class="default-form">

	<p class="form-row">
		<span class="calendar-input">
			<input type="text" name="hireOn" data-ng-model="dateData.starton_date" placeholder="<?php _e('Ngày thuê','autorent'); ?>" data-dateformat="dd-mm-yy">
			<i class="fa fa-calendar"></i>
		</span>
	</p>

	<span class="calendar-input">
		<input type="text" name="RetunOn" data-ng-model="dateData.returnon_date" data-ng-change="grabDate(dateData)" placeholder="<?php _e('Ngày trả','autorent'); ?>" data-dateformat="dd-mm-yy">
		<i class="fa fa-calendar"></i>
	</span>
