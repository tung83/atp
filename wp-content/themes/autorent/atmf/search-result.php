                        ...
                        <div class="overlay">
                            ...
                            <div class="overlay-shadow">
                                <div class="overlay-content">
                                     <a href="{{ post.post_permalink }}" class="btn white"><?php _e('Read More','autorent'); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="vechicle-specification">
                        ...
                        <header class="vechicle-header col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="header-inner">
                                <h4 class="title pull-left"><a href="{{ post.post_permalink }}">{{ post.post_title }}</a></h4>
            ...
            <div data-ng-if="postView == 'grid'">
                ...
                <div class="vechicle-single col-lg-4 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="vechicle-specification">
                        ...
                        <header class="vechicle-header col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="header-inner">
                                <h4 class="title"><a href="{{ post.post_permalink }}">{{ post.post_title }}</a></h4>
