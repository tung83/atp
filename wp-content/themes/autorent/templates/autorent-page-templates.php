<?php  
/**
 * Template Name: Autorent-Build-Pages
 *
 */
get_header();
  ...
  <?php if(isset($queried_posts) && !empty($queried_posts) && is_array($queried_posts)){ ?>
      ...
      <?php foreach ($queried_posts as $key => $value) { ?>
        ...
        <?php } elseif($block_type === 'content_block_with_social_link'){ ?>
          ...
          <!-- CONTENT BLOCK : BEGIN -->
          <section class="team heading-section" style="<?php if(isset($background_color) && !empty($background_color)) {?>background: <?php echo esc_attr($background_color);}?>; <?php if(isset($background_image) && !empty($background_image)){?>background-image: url(<?php echo esc_url($background_image[0]);}?>);background-size:cover;">
            <div class="container">  
        ...
        <?php }elseif($block_type === 'contact'){ ?>
         ...
         <?php }elseif($block_type === 'about_us'){ ?>
          ...
          <?php if(isset($block_post)){ ?>
              ...
              <section class="about about-description">
                <div class="container">
        ...
        <?php }elseif($block_type === 'testimonial'){ ?>
          ...
          <!-- TESTIMONIAL : BEGIN -->
          <section class="testimonials" style="<?php if(isset($background_color) && !empty($background_color)) {?>background: <?php echo esc_attr($background_color);}?>; <?php if(isset($background_image) && !empty($background_image)){?>background-image: url(<?php echo esc_url($background_image[0]);}?>);background-size:cover;">
